...
/// <summary>
/// Rule: <c>operation.summary</c>
/// Every operation must have a non-empty <c>summary</c> field.
/// </summary>
public sealed class OperationSummaryRule : IValidationRule
{
    public string Id => "operation.summary";
